...
<title>{{ $lang === 'en' ? 'Privacy policy — Budget Book' : 'Politika privatnosti — Knjižica troškova' }}</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=EB+Garamond:ital,wght@0,400;0,600;1,400&family=Cinzel:wght@600;900&display=swap" rel="stylesheet">
<style>
  :root{
    --leather:#2E1B14; --leather-hi:#4A2A1E;
    --parchment:#EFE1BE; --ink:#3B2A18; --ink-light:#7A6440; --gilt:#B8892B;
  }
  @media (prefers-color-scheme: dark){
    :root:not([data-theme="light"]){ --parchment:#241A12; --ink:#EDE0C8; --ink-light:#B8A588; --gilt:#C9A244; }
  }
  :root[data-theme="dark"]{ --parchment:#241A12; --ink:#EDE0C8; --ink-light:#B8A588; --gilt:#C9A244; }
  *{box-sizing:border-box;}
  body{
    ...
    font-family:'EB Garamond',Georgia,serif; color:var(--ink); padding:36px 16px;
  }
  .page{
    width:100%; max-width:680px; background:var(--parchment); border-radius:6px;
    padding:36px 34px 28px; box-shadow:0 30px 60px -20px rgba(0,0,0,0.7), inset 0 0 0 2px rgba(184,137,43,0.35);
  }
  h1{ font-family:'Cinzel',Georgia,serif; font-size:24px; margin:0 0 4px 0; }
  .updated{ font-size:12px; font-style:italic; color:var(--ink-light); margin-bottom:26px; }
  h2{ font-family:'Cinzel',Georgia,serif; font-size:15px; margin:26px 0 8px 0; color:var(--gilt); }
  p, li{ font-size:14px; line-height:1.65; }
  ul{ margin:8px 0; padding-left:20px; }
  .note{
    margin-top:28px; padding:12px 14px; border:1px dashed var(--ink-light);
    font-size:12.5px; color:var(--ink-light); font-style:italic;
  }
...
<body>
  <div class="page">
    @if ($lang === 'en')
      ...
      <div class="updated">Budget Book — personal ledger app</div>
      ...
      <ul>
        ...
        <li>If you use voice input or the receipt-scan feature: the recording is transcribed locally by your browser (not stored by us), and receipt photos are sent to Google's Gemini API for reading, not permanently stored on our servers afterward.</li>
      </ul>
    ...
    @else
      ...
      <div class="updated">Knjižica troškova — lična aplikacija za budžet</div>
      ...
      <ul>
        ...
        <li>Ako koristiš glasovni unos ili sken računa: glasovni unos prepoznaje sam tvoj pretraživač (mi ga ne čuvamo), a slika računa se šalje Google Gemini API-ju radi čitanja podataka, bez trajnog čuvanja na našim serverima nakon toga.</li>
      </ul>
